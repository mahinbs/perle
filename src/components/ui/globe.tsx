...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  useEffect(() => {
    ...
    // Use provided colors or defaults with better visibility
    globeMaterial.color = new Color(globeConfig.globeColor || "#0f4c75");
    globeMaterial.emissive = new Color(globeConfig.emissive || "#1a5490");
    globeMaterial.emissiveIntensity = globeConfig.emissiveIntensity || 0.3; // Much higher default for better visibility
  ...
  useEffect(() => {
    ...
    globeRef.current
      ...
      .hexPolygonColor(() => defaultProps.polygonColor || "rgba(255,255,255,0.85)");
  ...
  return (
    <group ref={groupRef as React.RefObject<any>}>
      {/* Globe is added via ref in useEffect */}
    </group>
  );
}
